...
class AuthService:
 ...
 print(f"[PASS] Successfully authenticated with Red Hat registry for user: {auth_request.username}")
 return RHAuthResponse(
 success=True,
 ...
 print(f"[FAIL] Red Hat authentication error: {str(e)}")
 return RHAuthResponse(
 success=False,
 ...
 print(f"[FAIL] Error checking RH auth status: {e}")
 return AuthStatus(
 authenticated=False,
 username=None,
 ...
 print(f"[FAIL] RH logout error: {e}")
 return LogoutResponse(
 success=False,
